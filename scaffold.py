...
class ProjectScaffolder:
        ...
        try:
            ...
            subprocess.run(
                [
                    ...
                    "commit",
                    "-m",
                    "Initial commit: Project scaffolded from MCP Workflows template",
                ],
                cwd=dest_dir,
                check=True,
                capture_output=True,
    ...
    def scaffold(self, project_name: str, dest_dir: Path | None) -> Path:
        ...
        print(f"Scaffolding new MCP Workflows project: {project_name}")
...
def main():
    ...
    parser.add_argument(
        "destination", nargs="?", help="Destination directory (default: current directory)"
    )
